...
function imprimirResultado($juego)
{
    ...
    if ($juego["puntosCruz"] > $juego["puntosCirculo"]) {
        echo $juego["nombreCruz"] . " GANASTE " . $juego["puntosCruz"] . " puntos!!!!!\n";
    } elseif ($juego["puntosCruz"] < $juego["puntosCirculo"]) {
        echo $juego["nombreCirculo"] . " GANASTE " . $juego["puntosCirculo"] . " puntos!!!!!\n";
    } else {
        echo "EMPATE ENTRE " . $juego["nombreCruz"] . " y " . $juego["nombreCirculo"] . ". " . $juego["puntosCruz"] . "  puntos para cada uno!!!!!\n";
    }
    echo "**********************\n";
}
...
function jugar()
{
    ...
    $cantMinimaCasillerosCompletosParaGanar = $dimensionTablero + ($dimensionTablero - 1);
    ...
    } while ($cantCasilleroCompletos < $cantMinimaCasillerosCompletosParaGanar);
    ...
    $juego = [
        "nombreCruz" => $nombreJugadorCruz,
        "nombreCirculo" => $nombreJugadorCirculo,
